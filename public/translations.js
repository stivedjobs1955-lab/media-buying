const TRANSLATIONS = {
  uz: {
    ...
    'hero.lead': "Meta, Google, Yandex va Telegram’da target va byudjet boshqaruvi.",
  ...
  ru: {
    ...
    'hero.lead': "Таргет и управление рекламным бюджетом в Meta, Google, Yandex и Telegram.",
  ...
  en: {
    ...
    'hero.lead': "Targeting and ad budget management across Meta, Google, Yandex and Telegram.",
